...
public class SubCatAdapter extends RecyclerView.Adapter<SubCatAdapter.MyViewHolder> {
    ...
    public SubCatAdapter(Activity activity, ArrayList<ImageListModel> categoryModelArrayList) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            image_main = (ImageView) view.findViewById(R.id.imageView_brands_only_listitem);
    ...
    public SubCatAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = inflater.inflate(R.layout.brands_only_listitem, parent, false);
        return new SubCatAdapter.MyViewHolder(v);
    }
